...
from .models import Feedback, MenPlayers, MenTeam, WomenPlayers, WomenTeam, db
...
def create_app(config_name=DevelopmentConfig):
    ...
    def index():
        print(config_name.SQLALCHEMY_DATABASE_URI)
    ...
    def league(league_path):
        ...
        teams = (
            ...
            .order_by(Team.win_percentage.desc())
            .all()
        )
        ...
        return render_template(
            ...
            fallback_player_portrait_url=fallback_player_portrait_url,
